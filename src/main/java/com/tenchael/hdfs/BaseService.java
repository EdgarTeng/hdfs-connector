...
public abstract class BaseService {
	...
	public String doGetAsString(String uri, Map<String, String> params) {
		...
		try {
			...
			json.put(NameRules.ATTR_HEADER, headersJson);
			...
			if (entity != null) {
				...
				if (content.startsWith("{") && content.endsWith("}")
					...
					json.put(NameRules.ATTR_BODY, bodyJson);
				} else {
					json.put(NameRules.ATTR_CONTENT, content);
				}
	...
	protected String create(File file, String uri, Map<String, String> params) {
		...
		Object obj = bean.get(NameRules.ATTR_HEADER);
